...
examples/loops/loops.O.bc: examples/loops/loops.rs
	rustc -O -C panic=abort examples/loops/loops.rs --emit=llvm-bc -o examples/loops/loops.O.bc

loops: examples/loops/loops.bc examples/loops/loops.O.bc
...
examples/const_folding/const_folding.O.bc: examples/const_folding/const_folding.rs
	rustc -O -C panic=abort examples/const_folding/const_folding.rs --emit=llvm-bc -o examples/const_folding/const_folding.O.bc

const_folding: examples/const_folding/const_folding.O.bc examples/const_folding/const_folding.bc

examples/sum/sum.bc: examples/sum/sum.rs
	rustc -C panic=abort examples/sum/sum.rs --emit=llvm-bc -o examples/sum/sum.bc

examples/sum/sum.O.bc: examples/sum/sum.rs
	rustc -O -C panic=abort examples/sum/sum.rs --emit=llvm-bc -o examples/sum/sum.O.bc

sum: examples/sum/sum.bc examples/sum/sum.O.bc
